...
public class Directory {
    ...
    public void createChildList() {
        ...
        if (fullPath.equals(ChooserConsts.NAME_TREE_ROOT)) {
            ...
            File folder = new File(fullPath);
            //folders = Arrays.asList(folder.listFiles());
        ...
        if (folders != null) {
            for (File file : folders) {
                if (file.isDirectory()) {
                    ...
                    //Model.Directory node = new Model.Directory(fullPath + "/" + file.getName() + "/");
                    //System.out.println(fullPath + "/" + file.toString() + "/");
                } else if(file.isFile()){
                    files.add(file);
                }
            }
    ...
    public int getChildCount() {
        ...
        return subDirectoryList.size()+files.size();
    }
